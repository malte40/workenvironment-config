...
autocmd FileType tex inoremap ,sec   \section{%DELRN%}<Enter><BS>\label{sec:%DELRN%}<Enter>(<>)<Esc>2k:MultipleCursorsFind<Space>%DELRN%<Enter>c
autocmd FileType tex inoremap ,ssec  \subsection{%DELRN%}<Enter><BS>\label{ssec:%DELRN%}<Enter>(<>)<Esc>2k:MultipleCursorsFind<Space>%DELRN%<Enter>c
autocmd FileType tex inoremap ,sssec \subsubsection{%DELRN%}<Enter><BS>\label{sssec:%DELRN%}<Enter>(<>)<Esc>2k:MultipleCursorsFind<Space>%DELRN%<Enter>c
